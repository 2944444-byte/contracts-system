  ...
  async function loadAll() {
    const [{ data: t }, { data: c }] = await Promise.all([
      ...
      supabase.from("contracts")
        .select("id, property_id, status, start_date, end_date, rent_per_sqm, charged_area, investment_addition, tenant_id, is_amendment, parent_contract_id, amendment_date, amendment_number, index_base_date, indexation_method, index_mechanism, properties(name), contract_spaces(area_override,follows_contract_options,spaces(space_name))")

  ...
  async function loadAll() {
    const [{ data: ins }, { data: pr }, { data: c }] = await Promise.all([
      ...
      supabase.from("contracts")
        .select("id, tenant_id, property_id, status, is_amendment, parent_contract_id, tenants(name), properties(name), contract_spaces(area_override,follows_contract_options,space_id, spaces(space_name))")

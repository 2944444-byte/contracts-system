...
export default function LettersPage() {
  ...
  async function loadAll() {
    const [{ data: l }, { data: c }, { data: t }] = await Promise.all([
      supabase.from("letters").select("*, contracts(tenant_id, property_id, parent_contract_id, tenants(id,name,primary_email,contact_email,email,contact_name,contacts),properties(id,name),contract_spaces(area_override,follows_contract_options,spaces(space_name)))").order("created_at",{ascending:false}),

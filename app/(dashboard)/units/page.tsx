...
export default function UnitsPage() {
  ...
  async function loadAll() {
    const [{ data: sp }, { data: pr }, { data: c }] = await Promise.all([
      ...
      supabase.from("contracts").select("id,property_id,tenant_id,status,is_amendment,parent_contract_id,amendment_number,amendment_date,start_date,tenants(name),contract_spaces(area_override,follows_contract_options,space_id)").in("status",["active","expiring","extended","upcoming","future"]),
    ]);

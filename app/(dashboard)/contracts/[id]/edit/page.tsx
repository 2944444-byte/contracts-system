  ...
  async function loadAll() {
    ...
    if (!c.is_amendment) {
      var { data: amendsData } = await supabase.from("contracts")
        .select("*, contract_spaces(area_override,follows_contract_options,space_id,charge_method,fixed_rent,price_per_sqm,index_base_value,index_base_date,use_original_index)")
